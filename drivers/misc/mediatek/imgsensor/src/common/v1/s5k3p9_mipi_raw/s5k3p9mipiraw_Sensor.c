...
#define DEVICE_VERSION_S5k3P9SP     "s5k3p9"
...
static struct imgsensor_info_struct imgsensor_info = {
		...
		.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//SENSOR_OUTPUT_FORMAT_RAW_4CELL_BAYER_Gb
		.mclk = 24,
...
/*
extern int S5K3P9_otp_read(void);
static int vivo_otp_read_when_power_on;
extern otp_error_code_t S5K3P9_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_S5K3P9[13];
*/
/*0 flag   1-12 data*/
/****hope add end****/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_INF("S5K3P9mipiraw_Sensor I2C_BUS = %d\n", I2C_BUS);
	if(I2C_BUS != 4){
			...
			*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				*sensor_id = S5K3P9_SENSOR_ID;
				...
				vivo_otp_read_when_power_on = S5K3P9_otp_read();
				LOG_INF("cfx_add:end read eeprom ---vivo_otp_read_when_power_on = %d,S5K3P9_OTP_ERROR_CODE =%d\n", vivo_otp_read_when_power_on, S5K3P9_OTP_ERROR_CODE);
				*/
				/*vivo hope  add end*/
				return ERROR_NONE;
			}
...
{
	int ret;
	int addr = 0x076C;	/*start of cross talk data*/
	...
	if(Is_Read_4Cell != 1)
	{
		...
		Four_Cell_Array[0] = (FOUR_CELL_SIZE & 0xff);
		Four_Cell_Array[1] = ((FOUR_CELL_SIZE >> 8) & 0xff);
		
		/*Multi-Read*/
		iReadRegI2C(pu_send_cmd,2,&Four_Cell_Array[2],FOUR_CELL_SIZE,EEPROM_READ_ID);
		Is_Read_4Cell = 1;
	}
