...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.custom1 = {
		...
		.framelength = 1606,      /* record different mode's framelength */
		.startx = 0,
		.starty = 0,
...
/* */
	...
	printk("gc02m1b set_shutter_frame_length shutter:%d, frame_length:%d, realtime_fps:%d, framelength =%d\n", shutter, frame_length, realtime_fps, imgsensor.frame_length);
}
...
#if USE_HWSYNC
kal_uint16 addr_data_pair_dual_sync_gc02m1b[] = {
		0xfe, 0x00,
		0x80, 0x00,
		0x82, 0x08,
		0x83, 0x0a,
...
#if USE_HWSYNC
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_dual_sync_gc02m1b,
		sizeof(addr_data_pair_dual_sync_gc02m1b) /
		sizeof(kal_uint16));
#endif
}
...
{
	LOG_INF("gc02m1b custom1_setting\n");
	gc02m1b_table_write_cmos_sensor(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->SensorModuleName = (char *)"GC02M1B";
	sensor_info->SensorModuleID = 3;
	sensor_info->SensorOtpID = 0;
